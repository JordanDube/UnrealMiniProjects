...
#include "FirstPersonShooter/DamageableActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	FIRSTPERSONSHOOTER_API UClass* Z_Construct_UClass_ADamageableActor_NoRegister();
	FIRSTPERSONSHOOTER_API UClass* Z_Construct_UClass_ADamageableActor();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bIsAttackable_MetaData[];
#endif
		static void NewProp_bIsAttackable_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsAttackable;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable_MetaData[] = {
		{ "Category", "Attack" },
		{ "ModuleRelativePath", "DamageableActor.h" },
	};
#endif
	void Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable_SetBit(void* Obj)
	{
		((ADamageableActor*)Obj)->bIsAttackable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable = { "bIsAttackable", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ADamageableActor), &Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable_SetBit, METADATA_PARAMS(Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADamageableActor_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADamageableActor_Statics::NewProp_bIsAttackable,
	};
	...
	IMPLEMENT_CLASS(ADamageableActor, 4290959953);
	template<> FIRSTPERSONSHOOTER_API UClass* StaticClass<ADamageableActor>()
	{
		return ADamageableActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ADamageableActor(Z_Construct_UClass_ADamageableActor, &ADamageableActor::StaticClass, TEXT("/Script/FirstPersonShooter"), TEXT("ADamageableActor"), false, nullptr, nullptr, nullptr);
